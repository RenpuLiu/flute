...
def noniid(dataset, num_users, shard_per_user, num_classes, rand_set_all=[]):
    ...
    if len(rand_set_all) == 0:
        ...
        open("/home/rjl5968/anaconda/content/fedup/save/rand_set_all.txt", "w").close()

        with open("/home/rjl5968/anaconda/content/fedup/save/rand_set_all.txt",'wb') as f:
            torch.save(torch.tensor(rand_set_all), f)
